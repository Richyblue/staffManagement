        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex flex-col flex-1 overflow-y-auto">
                ...
                <div className="bg-white shadow-lg p-6 mt-6 mb-6 w-full max-w-4xl mx-auto">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-center">Update Staff Data {Friend.first_name} {Friend.last_name}</h3>
                    {submissionStatus && (
                            <div
                     ...
                     <form className="" onSubmit={handleSubmitUpdateFriend}>
                        <hr className='mt-10 mx-8 mb-4'/>
                            <h2 className="font-bold sm:text-lg mb-4">Friend Family Menbers Informations</h2>
